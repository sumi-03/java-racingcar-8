...
public class ErrorMessages {
    ...
    public static final String ERROR_CAR_NAME_LENGTH = "자동차 이름 길이는 5자 이하만 가능합니다.";
    public static final String ERROR_NOT_NUMERIC = "입력값은 숫자여야 합니다.";
    public static final String ERROR_ATTEMPT_COUNT_MIN = "시도 횟수는 1 이상이어야 합니다.";
}
